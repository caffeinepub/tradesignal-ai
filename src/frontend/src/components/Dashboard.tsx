...
const AI_MODELS = [
  ...
  { id: "xai", name: "Grok-2", provider: "xAI", color: "oklch(0.72 0.15 300)" },
  {
    id: "groq",
    name: "Llama 3.1 70B",
    provider: "Groq",
...
export default function Dashboard() {
  ...
  return (
    <div className="h-screen flex flex-col bg-background grid-bg overflow-hidden">
      ...
      {/* Top controls bar */}
      <div
        className="shrink-0 flex items-center gap-2 px-3 py-2 border-b border-border overflow-x-auto"
      ...
      >
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          ...
          <input
            ...
            className="w-28 px-2 py-1 rounded text-xs font-mono bg-card border border-border text-foreground outline-none focus:border-primary transition-colors"
            placeholder="BTCUSDT"
          />
        </div>
          ...
          {TIMEFRAMES.map((tf) => (
            <button
              ...
              style={{
                ...
                border:
                  timeframe === tf ? "none" : "1px solid oklch(0.22 0.02 265)",
              }}
            >
              {tf}
            </button>
        ...
        <div className="ml-auto flex items-center gap-2 shrink-0">
          {autoAnalyzing && !isAnalyzing && (
            <span className="text-xs text-muted-foreground animate-pulse-slow">
              ● Auto...
            </span>
          )}
          {!providerApiKey && (
